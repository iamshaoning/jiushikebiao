...
- **快捷添加课程**：点击任意日期即可快速添加新课程
- **课程详情查看**：点击已有课程可查看详细信息或进行编辑
- **课程复制粘贴**：支持复制一天中的课程，粘贴到其他日期，智能检测时间冲突和重复课程
...
- **预设课时费**：可预设一对一课型课时费，排课时自动加载或自定义

### 课程管理

- **一对一课程**：支持一名学生单独上课
- **多人课课程**：支持多名学生同时上课，费用可按人数分摊或自定义
- **课时时长设置**：可自定义课程时长（30/60/90/120/150/180分钟）
...
- **数据可视化**：集成 Chart.js 实现统计图表展示
- **云端同步**：基于 Supabase 实现数据云端存储
- **模块化架构**：采用服务模块化设计，代码结构清晰
