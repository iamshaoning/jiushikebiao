...
export class TimelineModal {
    ...
    async show() {
        ...
        const getActionIcon = (type) => {
            const map = { 'add-course':'plus','paste-courses':'clipboard','update-course':'square-pen','delete-course':'trash-2','delete-day-courses':'trash-2','restore-snapshot':'rotate-ccw','batch-add-courses':'plus','batch-paste-courses':'clipboard','batch-delete-courses':'trash-2','batch-delete-day-courses':'trash-2' };
            return map[type] || 'circle';
        };

        const getActionColor = (type) => {
            const map = { 'add-course':'info','paste-courses':'warning','update-course':'success','delete-course':'danger','delete-day-courses':'danger','restore-snapshot':'info','batch-add-courses':'info','batch-paste-courses':'warning','batch-delete-courses':'danger','batch-delete-day-courses':'danger' };
