...
function ToastList() {
  ...
  return (
    <div className="fixed top-4 right-4 z-[100] flex flex-col items-end gap-2 max-w-md pointer-events-none">
      {toasts.map((t) => (
...
function ToastItem({ toast, onClose }: { toast: Toast; onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onClose}
        className="p-1 rounded hover:bg-[var(--bg-secondary)]/50 text-gray-400 hover:text-gray-600 flex-shrink-0"
        aria-label="关闭"
      >
