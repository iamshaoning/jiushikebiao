      ...
      >
        ...
        <div className="relative flex flex-col justify-between h-full">
          ...
          >
            ...
            <div className="font-display text-base font-bold leading-tight">玖拾课表</div>
          </div>
          ...
          >
            <h1 className="font-display text-5xl font-bold leading-tight text-white">排课 · 管理</h1>
          </div>
      ...
      >
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8 justify-center">
            ...
            <span className="font-display text-xl font-bold text-ink-700">玖拾课表</span>
          </div>
