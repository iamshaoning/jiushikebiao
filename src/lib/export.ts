 ...
 * HTML 导出（还原统计页面外观）
 *
 * 将统计页面导出为独立 HTML 文件（内联样式），便于离线查看/打印
 */
...
body{font-family:"LXGW WenKai",system-ui,-apple-system,"Segoe UI",sans-serif;background-color:#FAF7F2;color:#1a1a1a;line-height:1.6;padding:2rem}
.container{max-width:1000px;margin:0 auto}
header{margin-bottom:1.5rem}
header h1{font-family:"LXGW WenKai",Georgia,serif;font-size:1.5rem;font-weight:700;color:#08231A}
